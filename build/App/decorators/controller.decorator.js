...
function controller(prefix) {
    return function (target) {
        ...
        for (var key in target.prototype) {
            ...
            if (path) {
                (_c = router_singelton_1.Router.instance) === null || _c === void 0 ? void 0 : _c[method].apply(_c, __spreadArrays(["" + prefix + path], middlewares, [validator, MethodInController, catchError]));
            }
        }
    };
}
