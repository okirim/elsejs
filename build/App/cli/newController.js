...
function _createNewController(controllerName, projectPath) {
    ...
    fs_1.default.writeFileSync(projectPath + "/src/http/controllers/" + controllerName + ".controller.ts", controllerSub);
    fs_1.default.appendFileSync(projectPath + "/src/http/controllers/index.ts", "\n export * from './" + controllerName + "/" + controllerName + ".controller';");
}
