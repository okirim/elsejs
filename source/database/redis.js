...
var mongoose_singelton_1 = require("../build/singeltons/mongoose.singelton");
...
//@ts-ignore
mongoose_singelton_1.Mongoose.instance.Query.prototype.cache = function (hkey) {
    if (hkey === void 0) { hkey = 'default'; }
    //@ts-ignore
                ...
                case 0:
                    ...
                    client.hget(this._hkey, key, function (dataInCache) {
                        ...
                        return Array.isArray(documents) //@ts-ignore
                            ? documents.map(function (document) { return new _this.model(document); }) //if it's array
                            //@ts-ignore
